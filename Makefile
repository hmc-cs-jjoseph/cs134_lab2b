...
MODULES=lab2_list.c
DATA=lab2b_1.csv lab2b_2.csv lab2b_3.csv lab2b_4.csv lab2b_5.csv lab2b_list.csv
...
dist:
	tar -czvf lab2b-040161840.tar.gz Makefile README $(LISTSOURCES) $(MODULES) $(DATA) $(IMAGES) $(TESTS) $(GNUPLOT)
